...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_type == "hospital") {
        ...
        $hospital_city = $_POST["hospitalCity"];
        $hospital_state = $_POST["hospitalState"];
        $hospital_zip_code = $_POST["hospitalZip"];
    ...
    //for receiver
        ...
        $receiver_city =  $_POST["receiverCity"];
        $receiver_state =  $_POST["receiverState"];
        $receiver_zip_code =  $_POST["receiverZip"];
